    ...
    <el-form class="dialog-form" :model="entity" :rules="rules" ref="form" label-width="120px">
        <fieldset>
            ...
            <el-form-item label="活动时间" required>
                <el-date-picker v-model="timeValue" type="datetimerange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" @change="getSTime" :disabled="isDisabled"></el-date-picker>
            </el-form-item>
            <el-form-item label="主体类型" prop="issueType">
                <el-radio-group v-model="entity.issueType" :disabled="isDisabled">
                    ...
                    <br>
                    <el-radio :label="1">
                        <span class="title-text">分公司</span>
                        <branch-company-select v-model="entity.branchCompanyId" :clearable="true" :disabled="isDisabled"></branch-company-select>
                    </el-radio>
                    <br>
                    <el-radio :label="2"><span class="title-text">商户</span>
                            <branch-company-select v-model="entity.branchCompanyId"
                                                   :clearable="true" :disabled="isDisabled"></branch-company-select>
                            <merchant-select v-model="entity.merchantId" :clearable="true"
                                             :branchCompanyId="entity.branchCompanyId" :disabled="isDisabled"></merchant-select>
                    </el-radio>
                </el-radio-group>
            </el-form-item>
            ...
            <el-row span="24">
                <el-col span="12">
                    <el-form-item label="跳转类型" prop="urlType" :disabled="isDisabled">
                        <el-select v-model="entity.urlType" placeholder="请选择" :disabled="isDisabled">
                            <el-option v-for="item in urlTypes" :key="item.value" :label="item.label" :value="item.value"></el-option>
                        </el-select>
                    </el-form-item>

                </el-col>
                <el-col span="12">
                    <el-form-item label="H5页面" prop="urlH5" :disabled="isDisabled">
            ...
            <el-row span="24">
                <el-col span="12">
                    ...
                    <el-form-item label="安桌APP页面" prop="urlAndroid" :disabled="isDisabled">
                ...
                <el-col span="12">
                    ...
                    <el-form-item label="苹果APP页面" prop="urlIos" :disabled="isDisabled">
