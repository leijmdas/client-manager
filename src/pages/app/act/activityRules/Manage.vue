        ...
        <v-table :page="page" ref="table" :table-minheight="450">
            ...
            <el-table-column label="活动类型" prop="type" width="200px">
                <template slot-scope="{row}">
                    <span v-if="row.type == 100">新注册用户</span>
                    <span v-if="row.type == 101">老用户邀请(新用户注册)</span>
                    <span v-if="row.type == 102">老用户邀请(新用户首次使用)</span>
                    <span v-if="row.type == 201">BANNER图1</span>
                    <span v-if="row.type == 202">BANNER图2</span>
                    <span v-if="row.type == 203">BANNER图3</span>
                    <span v-if="row.type == 204">BANNER图4</span>
                    <span v-if="row.type == 205">BANNER图5</span>
                </template>
            </el-table-column>
            <!-- 0-平台1-子公司2-物业 -->
