        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="轮播图列表" name="first">
                <el-form :model="entity" ref="form">
                    <div style="margin-bottom: 20px; display: flex;justify-content: space-between"><el-button type="primary" @click="saveImg">保存</el-button> <span>备注：请上传PNG格式  尺寸大小为554px*676px</span></div>
            ...
            <el-tab-pane label="Banner图轮播" name="third">
                <el-form :model="entity" ref="form">
                    <div style="margin-bottom: 20px; display: flex;justify-content: space-between"><el-button type="primary" @click="saveBanner">保存</el-button> <span>备注：请上传PNG格式  尺寸大小为XXXpx*XXXpx</span></div>
                    <el-upload :action="action" list-type="picture-card" :data="formData" :beforeUpload="beforeUpload" :file-list="entitys.fileList" :on-success="handleSuccess" :auto-upload="true" :on-exceed="handleExceed" :on-remove="handleRemove" :limit="limit1">
                        <i slot="default" class="el-icon-plus"></i>
                    </el-upload>
                </el-form>
            </el-tab-pane>
