...
<template>
    <div>
        ...
        <v-table ref="table" :page="page" :table-minheight="450">
            ...
            <el-table-column prop="branchCompanyName" label="分公司" width="120">
                <template slot-scope="{row}">
                    {{row.branchCompanyId==0?'请设定分公司':row.branchCompanyName}}
                </template>
            </el-table-column>

            <el-table-column prop="code" label="商户编码" width="90">
            </el-table-column>
